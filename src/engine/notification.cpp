...
template<> hoa_notification::NotificationEngine* Singleton<hoa_notification::NotificationEngine>::_singleton_reference = NULL;

namespace hoa_notification {

NotificationEngine* NotificationManager = NULL;
...
void NotificationEngine::Notify(NotificationEvent* notification) {
	if (notification == NULL) {
		IF_PRINT_WARNING(NOTIFICATION_DEBUG) << "function received NULL argument" << endl;
		return;
	}
