...
function CreateSprites()
	...
	sprites["market_demon1"] = ConstructEnemySprite("scorpion", ObjectManager:GenerateObjectID(), 107, 129);
	sprites["market_demon1"]:SetContext(contexts["exterior"]);
	sprites["market_demon1"]:SetDirection(hoa_map.MapMode.EAST);
	ObjectManager:AddObject(sprites["market_demon1"]);

	sprites["market_demon2"] = ConstructEnemySprite("scorpion", ObjectManager:GenerateObjectID(), 107, 131);
	sprites["market_demon2"]:SetContext(contexts["exterior"]);
	sprites["market_demon2"]:SetDirection(hoa_map.MapMode.EAST);
	ObjectManager:AddObject(sprites["market_demon2"]);
...
function CreateDialogues()
	...
	event_dialogues["near_castle"] = 108;
